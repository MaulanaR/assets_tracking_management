...
const routes = [
	{
		...
		children: [
			...
			},
			{
				path: "create",
				element: ReactLazyWithSuspense(
					async () => await import("@/pages/masterdata/employees/create-employee"),
				),
			},
			{
				path: "edit/:id",
				element: ReactLazyWithSuspense(
					async () => await import("@/pages/masterdata/employees/edit-employee"),
				),
			},
			{
				path: "detail/:id",
				element: ReactLazyWithSuspense(
					async () => await import("@/pages/masterdata/employees/detail-employee"),
				),
			},
			{
				path: "delete/:id",
